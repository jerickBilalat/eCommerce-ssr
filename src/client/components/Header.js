                ...
                <div className="col-md-12">
                  ...
                  <nav id="navigation">
                    <ul className="menu" id="responsive">
                      ...
                      <li className={(this.props.match.path === "/cart" && "current cart-icon") || "cart-icon"}>
                        <Link to="/cart">
                          <i className="fa fa-shopping-cart" />
                          {this.props.cartItems ? <span className="cart-counter">{this.props.cartItems.length}</span> : null}
                        </Link>
                      </li>
                    </ul>
                  </nav>
